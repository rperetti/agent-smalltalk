...
today, [docs/phase5_spec.md](docs/phase5_spec.md) for the next phase (the
agent evolving its own reusable tools — DRAFT), [docs/ideas.md](docs/ideas.md)
for the parking lot, and [docs/postponed.md](docs/postponed.md) for ideas
worked out then consciously deferred.
