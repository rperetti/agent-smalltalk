...
Usage:
  ...
  ./smoke.sh --provider <fact-widget|widget|modify|textfield|facts|tools|selection|reactive>
...
case "$NAME" in
  ...
  provider-syntax)
    ...
    ;;
  fact-widget|widget|modify|textfield|facts|tools|selection|reactive)
